...
public class StudentService {
    ...
    public PageInfo<Student> selectPage(Student student, Integer pageNum, Integer pageSize) {
        ...
        for(Student dbStudent: students){
            Department department = departmentMapper.selectByClubRepid(dbStudent.getId());
            if(ObjectUtil.isNotEmpty(department)){
                dbStudent.setDepartmentName(department.getClubName());
            }
        }
    ...
    public List<Student> getAllReps(){
        return studentMapper.selectByTitle("ClubRepresentative");
    }
